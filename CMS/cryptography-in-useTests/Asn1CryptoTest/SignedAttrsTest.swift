...
//    let _sampleDataDocument = "QurOFR3lyq3KV3YyfOmCnK6r3cmuhdtYFJsQc0v/KpM="
    ...
    func testSignedAttrsEncodingWithData() throws {
        // Content Type
        let contentTypeAttribute = ContentTypeAttribute(value: OID.pkcs7data.rawValue)
        ...
        print(try signedAttributes.asn1encode(tag: nil).serialize().hexString())
